...
// Optional: close mobile filters when clicking outside
document.addEventListener('click', (e) => {
  if (filtersSidebar.classList.contains('show') && !filtersSidebar.contains(e.target) && e.target !== mobileFilterBtn) {
    filtersSidebar.classList.remove('show');
  }
});